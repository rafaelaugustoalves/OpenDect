...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_26 = QtGui.QLineEdit(self.splitter_19)
        ...
        self.lineEdit_27 = QtGui.QLineEdit(self.splitter_20)
